...
function auxin_get_content_width(){
    ...
    $single_width_name  = auxin_get_option( sprintf('%s_max_width_layout', $get_post_type ) );
    $archive_width_name = auxin_get_option( sprintf('%s_archive_max_width_layout', $get_post_type ) );
    
    if( is_singular( $get_post_type ) && ! is_front_page() && ! empty( $single_width_name ) ) {
        $theme_width_name = $single_width_name;    
    } elseif( ( is_archive() || auxin_is_blog() ) &&  ! empty( $archive_width_name ) ){
        $theme_width_name = $archive_width_name;
    }
