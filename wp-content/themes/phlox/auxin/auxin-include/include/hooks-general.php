...
function auxin_modern_comment_form( $comment_form ){
    ...
    $comment_form['comment_field'] = '<fieldset><textarea name="comment" id="comment" cols="45" rows="8" ' . ( $req ? "aria-required='true' required" : "" ) .' ></textarea><label for="comment">'. esc_attr__('Comment' , 'phlox' ). '</label><div class="aux-modern-form-border"></div></fieldset>';
    $comment_form['fields']        = array(
                'author' => '<fieldset><input type="text"  name="author" id="author" value="'. esc_attr( $commenter['comment_author'] ). '" size="30" '. ( $req ? "aria-required='true' required" : "" ) .' /><label for="author">' . esc_html__( 'Name (required)', 'phlox' ) . '</label><div class="aux-modern-form-border"></div></fieldset>',
                'email'  => '<fieldset><input type="email" name="email"  id="email" value="'. esc_attr( $commenter['comment_author_email'] ). '" size="30" ' . ( $req ? "aria-required='true' required" : "" ) .' /><label for="email">' . esc_html__( 'E-Mail (required)', 'phlox' ) . '</label><div class="aux-modern-form-border"></div></fieldset>',
                'url'    => '<fieldset><input type="url" name="url" id="url" value="'. esc_url( $commenter['comment_author_url'] ). '" size="30" /><label for="url">' . esc_html__( 'Website', 'phlox' ) . '</label><div class="aux-modern-form-border"></div></fieldset>'
            );
