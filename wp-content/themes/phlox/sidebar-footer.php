...
$display_subfooter = auxin_get_post_meta( $post, 'page_show_subfooter', 'default') ;
$display_subfooter = 'default' === $display_subfooter ? auxin_get_option( 'show_subfooter', '1' ) : $display_subfooter;

if( $display_subfooter ) {
