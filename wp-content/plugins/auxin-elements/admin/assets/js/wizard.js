        ...
        function window_loaded(){
            ...
            $('.aux-setup-demo-content .second-step input[type=checkbox]').change(function () {
                if ($('.featherlight-content').find('input[type=checkbox]').filter(':checked').length > 0) {
                    $('.featherlight-content').find('.button-next').data('callback', 'install_demos').attr('data-callback', 'install_demos').text(aux_setup_params.makedemo_text);
                } else {
                   $('.featherlight-content').find('.button-next').text(aux_setup_params.nextstep_text).data('callback', null).removeAttr('data-callback');
                }
            });               
            ...
            $('.aux-demo-item').click(function() {
                ...
                $('.aux-install-demo').attr( 'href', '#' + $(this).data('demo-id') ).removeClass('disabled');
            });
        ...
        function tb_control( type ){
            ...
            switch( type ) {
                case 'on':
                    ...
                    break;
                default:
                    $(".featherlight").unbind( "click.featherlight" );
