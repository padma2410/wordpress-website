...
function auxin_get_tile_pattern( $pattern, $index, $column_media_width ) {
    ...
    switch ( $pattern ) {
        case 'pattern-1':
            return auxin_tile_pattern_1( $index, $column_media_width );
        break;
        case 'pattern-2':
            return auxin_tile_pattern_2( $index, $column_media_width );
        break;
        case 'pattern-3':
            return auxin_tile_pattern_3( $index, $column_media_width );
        break;
        case 'pattern-4':
            return auxin_tile_pattern_4( $index, $column_media_width );
        break;
        case 'pattern-5':
            return auxin_tile_pattern_5( $index, $column_media_width );
        break;
        case 'pattern-6':
            return auxin_tile_pattern_6( $index, $column_media_width );
        break;
        case 'pattern-7':
            return auxin_tile_pattern_7( $index, $column_media_width );
        break;
        case 'pattern-8':
            return auxin_tile_pattern_8( $index, $column_media_width );
        break;
        default:
            return auxin_tile_pattern_default( $index, $column_media_width );
        break;
    }
