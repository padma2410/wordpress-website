								...
								<tr class="aux-plugin" data-slug="<?php echo esc_attr( $slug ); ?>">
						            ...
						            data-colname="Thumbnail">
						            	<?php
								            ...
								            elseif( in_array( $plugin['slug'], array( "autoptimize", "custom-facebook-feed", "flickr-justified-gallery", "wp-smushit", "wordpress-importer", "customizer-export-import", "envato-market" ) ) ) {
